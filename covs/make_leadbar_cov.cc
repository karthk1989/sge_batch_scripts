{
   ...
   const int nbins = 20;
   const int ndet = 4;
   char filePrefix[4][200] = {"../snmult_outputs/nd5_fhc_SNLEADBAR","../snmult_outputs/nd5_rhc_SNLEADBAR","../snmult_outputs/sk_fhc_SNLEADBAR", "../snmult_outputs/sk_rhc_SNLEADBAR"};
   ...
   TFile *fout = new TFile("sec_nucl_leadbar_cov.root","RECREATE");
   cov->Write("sec_nucl_leadbar_cov");
   fout->Close();
