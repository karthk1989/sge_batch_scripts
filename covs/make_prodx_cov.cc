{
   ...
   const int nbins = 20;
   const int ndet = 4;
   char filePrefix[4][200] = {"../prodx_outputs/nd5_fhc_PRODX","../prodx_outputs/nd5_rhc_PRODX","../prodx_outputs/sk_fhc_PRODX", "../prodx_outputs/sk_rhc_PRODX"};
   ...
   TFile *fout = new TFile("prod_xsec_cov.root","RECREATE");
