{
   ...
   const int nbins = 20;
   const int ndet = 4;
   char filePrefix[4][200] = {"../bmpt_outputs/nd5_fhc_BMPT","../bmpt_outputs/nd5_rhc_BMPT","../bmpt_outputs/sk_fhc_BMPT", "../bmpt_outputs/sk_rhc_BMPT"};
   ...
   TFile *fout = new TFile("mult_coverage_cov.root","RECREATE");
