{
   ...
   const int nbins = 20;
   const int ndet = 4;
   char filePrefix[4][200] = {"../alttert_outputs/nd5_fhc_ALTTERT","../alttert_outputs/nd5_rhc_ALTTERT","../alttert_outputs/sk_fhc_ALTTERT", "../alttert_outputs/sk_rhc_ALTTERT"};
   ...
   TFile *fout = new TFile("mult_tertiary_cov.root","RECREATE");
   cov->Write("mult_tertiary_cov");
   fout->Close();
