{
   ...
   const int nbins = 20;
   const int ndet = 4;
   char filePrefix[4][200] = {"../harp_outputs/nd5_fhc_HARP","../harp_outputs/nd5_rhc_HARP","../harp_outputs/sk_fhc_HARP", "../harp_outputs/sk_rhc_HARP"};
   ...
   TFile *fout = new TFile("harp_mult_cov.root","RECREATE");
   cov->Write("harp_mult_cov");
   fout->Close();
