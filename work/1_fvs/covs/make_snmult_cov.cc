{
   ...
   const int nbins = 20;
   const int ndet = 4;
   char filePrefix[4][200] = {"../snmult_outputs/nd5_fhc_SNMULT","../snmult_outputs/nd5_rhc_SNMULT","../snmult_outputs/sk_fhc_SNMULT", "../snmult_outputs/sk_rhc_SNMULT"};
   char nomFile[4][200] = {"../snmult_outputs/nd5_fhc_SNMULT_-1.root","../snmult_outputs/nd5_rhc_SNMULT_-1.root","../snmult_outputs/sk_fhc_SNMULT_-1.root","../snmult_outputs/sk_rhc_SNMULT_-1.root"};
   const int nflavor = 4;
   ...
   TFile *fout = new TFile("sec_nucl_mult_cov.root","RECREATE");
   cov->Write("sec_nucl_mult_cov");
   fout->Close();
