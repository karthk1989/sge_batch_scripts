...
## set file to source for ROOT
  ...
  run_nd1=false: run_nd1_fv=false;	# 2km det
  run_nd2=false; run_nd2_fv=true;	# surface det
  run_nd3=false; run_nd3_fv=false;	# INGRID hori.
  run_nd4=false; run_nd4_fv=false;	# INGRID vert.
  run_nd5=false; run_nd5_fv=true;	# nd280 basket
  run_nd6=false; run_nd6_fv=false;	# nd280 magnet  
  run_nd7=false;			# IWCD toch dir
  run_nd8=false;			# IWCD moz dir
  run_nd9=false;			# IWCD X=0 dir
    run_nd9_fv_h10=true;   # diff. angles/samples of E61 in X=0 dir
    run_nd9_fv_h7p7=false;  # diff. angles/samples of E61 in X=0 dir
...
#  OUT=${WORKDIR}/nominal_outputs
  OUT_BASE=/data/hyperk/fluxes/flukaFluxSet_allConfig/flux_tuning/error_scripts/sge_batch_scripts/work/1_fvs/out/  
