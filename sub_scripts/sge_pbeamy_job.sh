...
## This file:  sge_pbeamy_job.sh
## Sets pbeamy inputs for flux_throws 


 # --------------------- #
 # For systematic:  pbeamy #

  export THROW=${1}
  echo THROW = ${THROW}
  export FOLDER="pbeamy_outputs"
  export NAME="PBEAMY"
  export ARG="-type PBEAMY  -epbeam 0.4  -throw ${THROW}"
 # --------------------- #
